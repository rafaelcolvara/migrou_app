...
class PessoaDTO {
  ...
  PessoaDTO.fromJson(Map<String, dynamic> json):
    ...
    nome = json['nome'],
    email = json['email'],
    dataNascimento = new DateFormat('dd/MM/yyyy').parse(json.containsKey('dataNascimento')?json['dataNascimento']:'01/01/1900'),
    dataCadastro = new DateFormat('dd/MM/yyyy').parse(json.containsKey('dataCadastro')?json['dataCadastro']:'01/01/1900'),
    senha = json['senha'],
