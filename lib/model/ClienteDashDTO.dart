...
ClienteDashDTO(this.vendedor, this.dtUltimaCompra, this.vlrComprasRealizadas, this.qtdComprasRealizadas, this.vlrCashBack);
  ...
  ClienteDashDTO.fromJson(Map<String, dynamic> json):
      ...
      dtUltimaCompra = new DateFormat('dd/MM/yyyy').parse(json.containsKey('dtUltimaCompra')?json['dtUltimaCompra']:'01/01/1900'),
      vlrComprasRealizadas = json['vlrComprasRealizadas']==0?double.parse('0'):double.parse(json['vlrComprasRealizadas'].toString()),
